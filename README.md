...
Skills are grouped as on [cankun.me/skills](https://cankun.me/skills): general use, then design, then internal workflow.
...
| [deposition](./skills/deposition) | Build a shared mental model through independent judgment and dialogue. | `npx skills@latest add Wang-Cankun/cankun-skills --skill deposition` |
| [known-unknowns](./skills/known-unknowns) | Use the Rumsfeld matrix to articulate tacit judgment, connect dormant knowledge, and explore blind spots. | `npx skills@latest add Wang-Cankun/cankun-skills --skill known-unknowns` |

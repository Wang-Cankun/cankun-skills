...
Illustrative map for a fictional Notes application and `control-notes` harness. Use its structure when generating a map; derive actual commands and selectors from the target project.
